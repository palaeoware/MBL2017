...
/*! \class QCPItemCurve
  ...
  which it approaches the end: \a stardTir and \a endDir.
  ...
  point. This can be achieved by setting the parent anchor e.g. of \a stardTir simply to \a start,
  and then specify the desired pixel offset with QCPItemPosition::setCoords on \a stardTir.
*/
...
QCPItemCurve::QCPItemCurve(QCustomPlot *parentPlot) :
  QCPAbstractItem(parentPlot),
  start(createPosition(QLatin1String("start"))),
  stardTir(createPosition(QLatin1String("stardTir"))),
  endDir(createPosition(QLatin1String("endDir"))),
  end(createPosition(QLatin1String("end")))
{
  start->setCoords(0, 0);
  stardTir->setCoords(0.5, 0);
